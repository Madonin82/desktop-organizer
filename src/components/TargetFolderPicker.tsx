...
export const TargetFolderPicker: React.FC<TargetFolderPickerProps> = ({
  ...
  const quickPresets = [
    { label: 'Pictures', value: 'Desktop\\Pictures' },
    { label: 'Documents', value: 'Desktop\\Documents' },
    { label: 'Shortcuts', value: 'Desktop\\Shortcuts' },
    { label: 'Installers', value: 'Desktop\\Installers' },
    { label: 'Archives', value: 'Desktop\\Archives' },
    { label: 'Organized 2026', value: 'Desktop\\Organized 2026' },
    { label: 'Cleanup Box', value: 'Desktop\\Desktop Cleanup' },
  ];
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="e.g. Desktop\Pictures or Desktop\My Chosen Folder"
            ...
            {existingFolders.length > 0 && (
              <div className="shrink-0">
                <select
                  ...
                  onChange={(e) => {
                    if (e.target.value) setTargetFolderName(`Desktop\\${e.target.value}`);
                  }}
                  defaultValue=""
